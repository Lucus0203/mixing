...
<article id="container">
	<div class="main">
            <p class="shack_img"><img src="<?php echo base_url();?>img/shake_img.png" width="15%" /><span id="visibility">还是摇一摇</span></p>
		<div class="photo">
                    <img src="/uploads/fuli/<?php echo round(rand(301, 305)).'.jpg'; ?>" />
			<div class="fragment">
				<div id="fragBox03">
            ...
            <div class="chooseBox">
                <p>福利都看过了,还要啥福利~</p>
                <div class="btn" style="width: 80%;"><a class="seeResult" href="#">看结果</a></div>
            </div>
...
$('.seeResult').click(function(){
    ...
    window.location=baseUrl+'curiosity/seeresult/'+percent+'/'+Math.round(shakeSpeed)+'/'+shake/2+'/'+3;
    return false;
});
$(window).unload(function(){
    if(seeresultflag){
        ...
        $.ajax({
                ...
                async:false,
                data:{'percent':percent,'shakeSpeed':Math.round(shakeSpeed),'shakeCount':shake/2,'step':3},
