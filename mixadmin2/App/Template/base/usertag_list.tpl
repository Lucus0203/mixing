...
<td valign="top" align="center">
 	<div class="main_ta_box">
         ...
         <form action="{url controller=Base action=AddUserTagTeam}" method="post">
         ...
         <form action="{url controller=Base action=AddUserTag}" method="post">
         <table class="hd_del_ta" border="0" cellpadding="0" cellspacing="1" width="97%" align="center" style="margin-bottom:30px;">
                <colgroup>
                        <col width="45%">
                        <col width="45%">
            ...
            <colgroup>
             ...
             <tr>
                 ...
                 <td style="word-break:keep-all;">
                 	<a href="{url controller=Base action=EditUserTag id=$list[sec].id}">编辑</a><a class="delBtn" href="{url controller=Base action=DelUserTag id=$list[sec].id}">删除</a>
                 </td>
             </tr>
             {/section}
         </table>
