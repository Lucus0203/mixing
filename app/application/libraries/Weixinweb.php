...
class Weixinweb{
	...
	function __construct() {
		$this->_appID="wx63a0f936a17f5857";//搅拌网页//wx8d69b946f39e0a65
		$this->_appsecret="ea973606536c7d69e476302e9b722f88";//搅拌网页//933ba61a9ca2fb8fad1aaa0f6779f15f
	}
	...
	private function __clone() {
        ...
        function getCodeRedirect($redirecturi,$state){
            ...
            $uri="https://open.weixin.qq.com/connect/qrconnect?/authorize?appid=".$this->_appID."&redirect_uri=".  urlencode($redirecturi)  ."&response_type=code&scope=snsapi_userinfo&state=".$state."#wechat_redirect";
