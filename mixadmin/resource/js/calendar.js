...
Calendar.prototype.getStyle = function()
{
	...
	str += '.calendar{position:absolute;width:160px!important;width /**/:160px;height:160px!important;height /**/:160px;background-color:'+this.style.bodyBackColor+';border:1px solid ' + this.style.borderColor + ';left:0px;top:0px;z-index:9999;margin:5px 0 0 0;}\n';
	str += '.cdrHeader{vertical-align:middle;background-color:'+ this.style.headerBackColor +';width:160px;height:22px;font-size:12px;color:'+this.style.headerFontColor+';}\n';
	str += '.cdrWatermark{position:absolute;left:0px;top:55px;width:160px;font-family: Arial Black;font-size:50px;color:'+this.style.watermarkColor+';z-index:1;text-align:center;}\n';
	...
	str += '.cdrBody{width:160px;height:100px!important; height /**/:100px;font-size:12px;cursor:pointer;color:' + this.style.bodyFontColor + ';}\n';
	str += '.dayOver{padding:0px;border:1px solid black;background-color:#f4f4f4;}\n';
