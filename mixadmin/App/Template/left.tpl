<td width="184" valign="top">
	<div class="main_l">
    	<div class="main_l_menu"><a href="{url controller=PublicEvent action=Index}">官方活动</a></div>
    	<div class="main_l_menu"><a href="{url controller=PublicEvent action=Add}">发起活动</a></div>
    	<div class="main_l_menu"><a href="{url controller=Shop action=Index}">咖啡店铺</a></div>
