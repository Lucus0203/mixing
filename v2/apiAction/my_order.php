...
function orderlist(){
	...
	$start = ($page_no - 1) * $page_size;
        $sql="select od.id as order_id,od.encouter_id,od.shop_id,encouter.type as encouter_type,encouter.product_img1,encouter.product1,encouter.price1,encouter.product_img2,encouter.product2,encouter.price2,encouter.status,shop.title as shop,od.amount,date_format(od.created,'%Y-%c-%d') as created from ".DB_PREFIX."order od "
